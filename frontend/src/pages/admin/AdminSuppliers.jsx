        ...
        },
        {
            ...
            render: (row) => (
                <div className="flex space-x-2">
                    <button onClick={() => handleEdit(row)} className="p-1 text-primary hover:bg-primary/10 rounded transition-colors" title="Edit Supplier">
                        <Edit2 size={16} />
                    </button>
                    {row.is_active && (
                        <button onClick={() => setConfirmDelete({ isOpen: true, id: row.id })} className="p-1 text-red-500 hover:bg-red-500/10 rounded transition-colors" title="Deactivate Supplier">
                            <Trash2 size={16} />
                        </button>
                    )}
                </div>
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-bold text-white tracking-tight">Suppliers Database</h1>
                    <p className="text-muted mt-1">Manage global logistics partners</p>
                </div>
